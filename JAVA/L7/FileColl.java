...
public class FileColl extends Modification<Man> {
    ...
    public void writeToFile(Scanner scan){
        System.out.println("Enter file name:");
        try {
            FileWriter fileWriter = new FileWriter("D:\\УНИВЕР\\3К1С\\РПС и СПП\\LAB3\\src\\LABS\\L6\\P3\\" + scan.nextLine(), true);
    ...
    public void readFromFile(Scanner scan){
        System.out.println("Enter file name:");
        try {
            FileReader fileReader= new FileReader("D:\\УНИВЕР\\3К1С\\РПС и СПП\\LAB3\\src\\LABS\\L6\\P3\\" + scan.nextLine());

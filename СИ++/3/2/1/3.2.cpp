...
1)	конструкторы следующих видов:
 	...
 	конструктор, инициализирующий все переменные класса значениями, за-данными в качестве параметров;
...
int main() {
  ...
  ZKX zkx2("Vodosnabzhenie","Vodokanal",20);
  zkx2.vyvod();
  ...
  ZKX *pzkx2 = new ZKX("Otoplenie","Top",10);
  pzkx2->vyvod();

  ZKX *pzkx3 = new ZKX(*pzkx1);
  pzkx3->vyvod();
